...
namespace dotNES.Neat
{
    abstract class SimpleNeatExperiment : INeatExperiment
    {
        ...
        public NeatEvolutionAlgorithm<NeatGenome> CreateEvolutionAlgorithm(IGenomeFactory<NeatGenome> genomeFactory, List<NeatGenome> genomeList)
        {
            ...
            IGenomeListEvaluator<NeatGenome> genomeListEvaluator = new ParallelGenomeListEvaluator<NeatGenome, IBlackBox>(genomeDecoder, PhenomeEvaluator, new ParallelOptions { MaxDegreeOfParallelism = SMBNeatUI.Instances });
