...
{
    public class SMBEvaluator : IPhenomeEvaluator<IBlackBox>
    {
        ...
        public SMBEvaluator(string stateFile, AbstractNetworkTrainer.UpdateMemoryMapperRef handler)
        {
        ...
        public FitnessInfo Evaluate(IBlackBox box)
        {
            ...
            Emulator emu = LoadState(stateFile);
            ...
            IMemoryMapper mapper = new SMBMemoryMapper(ref emu);

            // TODO: Update mapper to the correct index - need to identify the thread correctly...
            handler(ref mapper, 0);
        ...
        private SMBMemoryMapper.GameStats GetGameStats(IMemoryMapper mapper)
        {
            SMBMemoryMapper.GameStats gameStats = (SMBMemoryMapper.GameStats)mapper.FetchGameStats();
            return gameStats;
        }

        private SMBMemoryMapper.PlayerStats GetPlayerStats(IMemoryMapper mapper)
        {
